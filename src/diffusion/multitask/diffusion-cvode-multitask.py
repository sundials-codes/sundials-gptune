...
def parse_args():
    ...
    parser.add_argument('-tla_diffusion_coeff', type=int, default=0, help='Diffusion coefficient to predict parameters for')
...
def main():
    ...
    for tid in range(NI):
        ...
        if args.tla_diffusion_coeff != 0:
            newtask = [[args.tla_diffusion_coeff]]
