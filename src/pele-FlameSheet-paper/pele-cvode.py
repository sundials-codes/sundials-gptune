...
def main():
    ...
    problem_name = 'pele-cvode-' + args.mechanism + '-' + str(max_steps) + solve_type
    TUNER_NAME = 'GPTune'
    ...
    if solve_type == 'newton_all':
        parameter_space_list += [
            Categoricalnorm(['gmres', 'bcgs', 'direct'], transform='onehot', name='solver')
        ]
        ...
        parameter_space_list += [
            Categoricalnorm(['newton_gmres', 'newton_bcgs', 'newton_direct', 'fixedpoint'], transform='onehot', name='solver')
        ]
